class AluguelsController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to aluguels_path, status: :see_other, notice: "Aluguel was successfully destroyed." }
  ...
  private
    ...
    def set_aluguel
      @aluguel = Aluguel.find(params.require(:id))
    end

    # Only allow a list of trusted parameters through.
    def aluguel_params
      params.require(:aluguel).permit(:usuario_id, :livro_id, :data_inicial, :data_entrega)
    end
end
