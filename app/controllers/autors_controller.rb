class AutorsController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to autors_path, status: :see_other, notice: "Autor was successfully destroyed." }
  ...
  private
    ...
    def set_autor
      @autor = Autor.find(params.require(:id))
    end

    # Only allow a list of trusted parameters through.
    def autor_params
      params.expect(autor: [ :nome ])
    end
end
