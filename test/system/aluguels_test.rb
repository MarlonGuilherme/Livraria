...
class AluguelsTest < ApplicationSystemTestCase
  ...
  test "should create aluguel" do
    ...
    fill_in "Data entrega", with: @aluguel.data_entrega
    fill_in "Data inicial", with: @aluguel.data_inicial
    fill_in "Livro", with: @aluguel.livro_id
    fill_in "Usuario", with: @aluguel.usuario_id
