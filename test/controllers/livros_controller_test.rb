...
class LivrosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create livro" do
    assert_difference("Livro.count") do
      post livros_url, params: { livro: { autor_id: @livro.autor_id, descricao: @livro.descricao, nome: @livro.nome } }
    end
  ...
  test "should update livro" do
    patch livro_url(@livro), params: { livro: { autor_id: @livro.autor_id, descricao: @livro.descricao, nome: @livro.nome } }
